...
def mutual_information_registration(fixed_image_path, moving_image_path):
    ...
    multi_band_with_thermal = np.dstack((overlay, moving_resampled_np))
    ...
    print("multi band image shape:", multi_band_with_thermal.shape)
    ...
    plt.subplot(1, 3, 3)
    plt.imshow(cv2.cvtColor(multi_band_with_thermal, cv2.COLOR_BGR2RGB))
    ...
    cv2.imwrite(
        r"C:\Users\TEK1\OneDrive - Syracuse University\syracuse university\Thesis\pictures\final 5 band image\4 band with thermal.jpg",
        cropped_output)
    cv2.imwrite(
        r"C:\Users\TEK1\OneDrive - Syracuse University\syracuse university\Thesis\pictures\final 5 band image\final4.jpg",
        output)
    #cv2.imwrite( r"C:\Users\TEK1\OneDrive - Syracuse University\syracuse university\Thesis\pictures\final 5 band image\4band thermal.jpg",multi_band_with_thermal)
...
fixed_image_path = r'C:\Users\TEK1\OneDrive - Syracuse University\syracuse university\Thesis\pictures\Field july 2024\Images from Dorhea and Lepton\20240725-132842\20240725-132844-NIR-ON.jpg'
moving_image_path = r'C:\Users\TEK1\OneDrive - Syracuse University\syracuse university\Thesis\pictures\Field july 2024\Images from Dorhea and Lepton\20240725-132842\IMG_0000.pgm'
